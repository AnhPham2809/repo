...
public class CourseDBManagerTest {
	...
	public void testShowAll() {
		dataMgr.add("CMSC203",30504,4,"SC450","Joey Bag-O-Donuts"); // 9, comes last
		dataMgr.add("CMSC203",30503,4,"SC450","Jill B. Who-Dunit");  // 8, comes second
		dataMgr.add("CMSC204",30559,4,"SC450","BillyBob Jones"); // 7, comes first
